...
let customXULTreeView = exports.customXULTreeView = function (term, find = false, tree = null, filtered = false) {
	...
	Windows.getMostRecentWindow().setTimeout(function () { tree.view.selection.select(toSelect) },0);
	}
};
