...
Modifiers.fromEvent = function(event) {
        ...
        if (getModifierState(event,"Control") && -1 == modifiers.indexOf("altgr")) { modifiers.push("control"); }
        if (getModifierState(event, "Alt") && -1 == modifiers.indexOf("altgr")) { modifiers.push("alt"); }
