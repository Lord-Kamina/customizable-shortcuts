...
// 	console.warn("Analyzing key id: "+element.getAttribute("id")+": element.key(raw): ("+element.getAttribute("key")+"), this.key(codePointAt): ("+this.key+"), this.keycode: ("+this.keycode+")");
