...
if ("upgrade" == self.loadReason) {
	var md = require('markdown-it/dist/markdown-it.min.js')({
  		html: false,
  		linkify: true,
  		typographer: true,
  		xhtmlOut:     true
	...
	Windows.getMostRecentWindow().setTimeout(function() {windowMediator.getMostRecentWindow("Keybinder:ReleaseNotes").focus()},0);
}
